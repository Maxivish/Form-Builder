  ...
  return (
    <section className="p-10 pt-7 max-w-screen-xl mx-auto">
      ...
      <div className="mt-4 flex flex-wrap justify-between items-center">
        <div>
          {`Showing ${totalData === 0 ? 0 : 1 + (pageNo - 1) * pageSize} to ${totalData < pageSize ? totalData : pageNo * pageSize
            } of ${totalData}`}
        </div>

        <div className="flex">
          <button
            className="py-1 px-2 bg-purple-900 hover:bg-purple-700 disabled:bg-purple-700 disabled:cursor-not-allowed text-white rounded-s-md border-e border-solid border-neutral-400"
          ...
          <button
            title="current page"
            className="py-1 px-2 bg-white-900 text-black border-e border-solid border-neutral-400 cursor-none"
          >
            {pageNo}
          </button>
          ...
          <button
            className="py-1 px-2 bg-purple-900 hover:bg-purple-700 disabled:bg-purple-700 disabled:cursor-not-allowed text-white rounded-e-md"
            onClick={() => setPageNo(pageNo + 1)}
            disabled={
              Number(totalData) < 1 ||
